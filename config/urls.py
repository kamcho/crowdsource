...
urlpatterns = [
    ...
    path('wishlist/', commerce_views.wishlist_list, name='wishlist_list'),
    path('wishlist/toggle/', commerce_views.wishlist_toggle, name='wishlist_toggle'),
    path('wishlist/remove/<int:product_id>/', commerce_views.wishlist_remove, name='wishlist_remove'),
    ...
    path('complaints/create/', commerce_views.complaint_create, name='complaint_create'),
    path('complaints/<int:complaint_id>/', commerce_views.complaint_detail, name='complaint_detail'),
